...
def build_model(args):
    ...
    if args.method_type == "order":
        model = models.OrderEmbedder(3, args.hidden_dim, args)
...
def train(args, model, logger, in_queue, out_queue):
    ...
    while not done:
        ...
        for batch_target, batch_neg_target, batch_neg_query in zip(*loaders):
            ...
            pos_a, pos_b, neg_a, neg_b, pos_label, neg_label = data_source.gen_batch(batch_target,
...
def train_loop(args):
    ...
    for batch_target, batch_neg_target, batch_neg_query in zip(*loaders):
        ...
        # print([print(i.nodes) for i in pos_a.G])
        # print([print(i) for i in pos_b.G])
        if pos_a:
        ...
        '''
        print(pos_a, pos_b, neg_a, neg_b, sep='\n')
        sys.exit()
        '''
        test_pts.append((pos_a, pos_b, neg_a, neg_b, pos_label, neg_label))
