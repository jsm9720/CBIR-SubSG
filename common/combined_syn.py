...
class ERGenerator(dataset.Generator):
    ...
    def generate(self, size=None):
        ...
        logging.debug('Generated {}-node E-R graphs with average p: {}'.format(
                num_nodes, mean))
        #print("ERGenerator graph : ",graph)
        #print("ERGenerator type :",type(graph))
        return graph
...
class WSGenerator(dataset.Generator):
    ...
    def generate(self, size=None):
        ...
        #print("WSGenerator graph : ",graph)
        #print("WSGenerator type :",type(graph))
        return graph
...
class BAGenerator(dataset.Generator):
    ...
    def generate(self, size=None):
        ...
        logging.debug('Generated {}-node extended B-A graph with max m: {}'.format(
                num_nodes, max_m))
        #print("BAGenerator graph : ",graph)
        #print("BAGenerator type :",type(graph))
        return graph
...
class PowerLawClusterGenerator(dataset.Generator):
    ...
    def generate(self, size=None):
        ...
        logging.debug('Generated {}-node powerlaw cluster graph with max m: {}'.format(
                num_nodes, max_m))
        #print("PLCGenerator graph : ",graph)
        #print("PLCGenerator type :",type(graph))
...
def main():
    ...
    dataset = get_dataset("graph", 5, sizes)
